...
## [11.13.0](https://github.com/SDGLBL/codecompanion.nvim/compare/v11.17.1...v11.13.0) (2025-01-28)
...
* :sparkles: `CodeCompanionCmd` to write command-line commands ([da52e53](https://github.com/SDGLBL/codecompanion.nvim/commit/da52e53bcc69fb00c28e19edce61f927af2e683d))
...
* :sparkles: support `render-markdown.nvim` plugin ([9b137be](https://github.com/SDGLBL/codecompanion.nvim/commit/9b137be7a9c275d865c9b10d5173e0a1f588aa47))
...
* /buffer slash command can select multiple buffers ([e88b703](https://github.com/SDGLBL/codecompanion.nvim/commit/e88b7036a6428ce82b7254b0a2d58ae869635bbd))
* **adapters:** :sparkles: add xAI ([516e320](https://github.com/SDGLBL/codecompanion.nvim/commit/516e3204f6e9fefb827bad985b7104a2fb82a291))
* **adapters:** ✨ add Azure OpenAI ([#386](https://github.com/SDGLBL/codecompanion.nvim/issues/386)) ([542628d](https://github.com/SDGLBL/codecompanion.nvim/commit/542628dd68e26bbb59699aa48fe98b83a3798999))
* **adapters:** add claude-3-5-sonnet to Copilot ([1121015](https://github.com/SDGLBL/codecompanion.nvim/commit/1121015dbbce25afce88746861edc6fe930b7a9f))
...
* **adapters:** allow for o1 models at some point with improved schema ([601fa72](https://github.com/SDGLBL/codecompanion.nvim/commit/601fa72b09327f57e0703539673ef120ba3f420c))
...
* **adapters:** update the new haiku model ([#404](https://github.com/SDGLBL/codecompanion.nvim/issues/404)) ([9b00ed3](https://github.com/SDGLBL/codecompanion.nvim/commit/9b00ed39c11f43fbb829bcbada2f0a7105dfcee6))
* add language configuration for LLM responses ([#410](https://github.com/SDGLBL/codecompanion.nvim/issues/410)) ([e1a39bb](https://github.com/SDGLBL/codecompanion.nvim/commit/e1a39bb4e19cbda955a0f3caf09b78b798d10c4c))
* add native completions ([a1147f8](https://github.com/SDGLBL/codecompanion.nvim/commit/a1147f8133707251603525acf6a87f5c12ef3a70))
* add new events ([9b85331](https://github.com/SDGLBL/codecompanion.nvim/commit/9b8533143e381fb0dd4e5c733217dac8f9852ea4))
* **anthropic:** update to latest anthropic models ([#353](https://github.com/SDGLBL/codecompanion.nvim/issues/353)) ([bdf4acc](https://github.com/SDGLBL/codecompanion.nvim/commit/bdf4acc623316e0f63f1a5d71b0c5bbceeb7263b))
* **anthropic:** update to latest sonnet-3-5 model ([#346](https://github.com/SDGLBL/codecompanion.nvim/issues/346)) ([1d36e27](https://github.com/SDGLBL/codecompanion.nvim/commit/1d36e272a6e0d8ea7a4e940667335320762b6bc6))
...
* **chat:** :sparkles: yank the last code block ([f095b77](https://github.com/SDGLBL/codecompanion.nvim/commit/f095b77f43a6fd4ef014304dee636f78c02faba5))
* **chat:** `yank_code` can now copy current code block and highlight the yank ([a84f826](https://github.com/SDGLBL/codecompanion.nvim/commit/a84f8267c1deca5b81e4974e2190a58fd71c3733))
...
* **chat:** can toggle system prompt on/off in the chat buffer ([c157329](https://github.com/SDGLBL/codecompanion.nvim/commit/c15732913d695a7def6b99f22210293bb7d58889))
...
* **chat:** display references which are shared with the LLM in the UI ([767efee](https://github.com/SDGLBL/codecompanion.nvim/commit/767efee2ff8fd7d84ac9a5ff35bac52eecec5584))
* **chat:** keymaps can be custom functions ([5f729f9](https://github.com/SDGLBL/codecompanion.nvim/commit/5f729f91a6b6a4025f8e4753d2c2c29810da0149))
* **chat:** tools and variables are now added to references ([a291a05](https://github.com/SDGLBL/codecompanion.nvim/commit/a291a05233f8ecf7b86a163dcd8bd349f319ff43))
...
* **copilot:** now working with o1 models ([7283611](https://github.com/SDGLBL/codecompanion.nvim/commit/72836115615b62065507431b8a9a8523d224f8e4))
...
* **keymaps:** add condition logic ([c4eb21e](https://github.com/SDGLBL/codecompanion.nvim/commit/c4eb21e89ecf466416b75395ac00bf3db83838e7))
* mini_pick can select multiple buffers ([#413](https://github.com/SDGLBL/codecompanion.nvim/issues/413)) ([031a9e9](https://github.com/SDGLBL/codecompanion.nvim/commit/031a9e9d253872308d22c6619fa7e7db62ba7fc7))
* **mini_pick:** allow multi selection in /files ([#444](https://github.com/SDGLBL/codecompanion.nvim/issues/444)) ([68e0610](https://github.com/SDGLBL/codecompanion.nvim/commit/68e0610fa847ad818f621006746ff4a5f911371f))
* **openai:** support for o1 models ([6f98005](https://github.com/SDGLBL/codecompanion.nvim/commit/6f980055b49d1c96af1c63943152147b4f303ab8))
...
* **slash_commands:** `symbols` can now be from a selected file ([5356829](https://github.com/SDGLBL/codecompanion.nvim/commit/53568298687773f1c0113b873fd8cdd2968208a7))
* **slash_commands:** add a `default` provider ([c938304](https://github.com/SDGLBL/codecompanion.nvim/commit/c938304fd494a0bb29c917de5963230334649a15))
* **slash_commands:** help can now select multiple docs ([57e8e54](https://github.com/SDGLBL/codecompanion.nvim/commit/57e8e54df850749eb98001f52af5bc4f60b79f0e))
* **tools:** :sparkles: add `[@files](https://github.com/files)` tool ([22ebfb8](https://github.com/SDGLBL/codecompanion.nvim/commit/22ebfb8437e833aa6b25d032a0e1833e736d1d06))
* **tools:** :sparkles: Add `cmd_runner` tool ([ff7ad7f](https://github.com/SDGLBL/codecompanion.nvim/commit/ff7ad7f9e18fb9656e8de23bc540988336a7a93c))
* **tools:** :sparkles: tools can be stacked to form agents ([ee483b4](https://github.com/SDGLBL/codecompanion.nvim/commit/ee483b4e11d4c4e64a01ca6fb03c07edf6b2e20c))
...
* **tools:** add read option to `[@files](https://github.com/files)` tool ([cb63d59](https://github.com/SDGLBL/codecompanion.nvim/commit/cb63d59fa3ec4a31ebed1a1db00e1b25f8886686))


### Bug Fixes

* [#362](https://github.com/SDGLBL/codecompanion.nvim/issues/362) use actual line breaks for new lines ([9938867](https://github.com/SDGLBL/codecompanion.nvim/commit/993886723868b6fe0340d294f2f3d2a7acc6ae26))
* [#423](https://github.com/SDGLBL/codecompanion.nvim/issues/423) diff provider and `before` inline prompt ([f9a54cc](https://github.com/SDGLBL/codecompanion.nvim/commit/f9a54cc28a861770c3b3db787353b24e7fd0cd2d))
* [#427](https://github.com/SDGLBL/codecompanion.nvim/issues/427) long prompts causing issue with curl ([d5bef40](https://github.com/SDGLBL/codecompanion.nvim/commit/d5bef403460908069810726ffe79039d4c69f054))
* [#435](https://github.com/SDGLBL/codecompanion.nvim/issues/435) navigate chat buffers ([5779868](https://github.com/SDGLBL/codecompanion.nvim/commit/5779868e2db9fd056c835f375a57287bf46444f0))
...
* **adapters:** azure_openai deployment model mapping ([907e47a](https://github.com/SDGLBL/codecompanion.nvim/commit/907e47ac490a9ab91be8db820e99be6845e0cdc5))
...
* allow register to be customised ([dc98cf2](https://github.com/SDGLBL/codecompanion.nvim/commit/dc98cf2f12129d5dd5300d9b7d323d8ecd8be974))
...
* cancel requests to llm ([3a69421](https://github.com/SDGLBL/codecompanion.nvim/commit/3a694217ec868a8551fb6ec3203b98dad11888c9))
* **chat:** [#447](https://github.com/SDGLBL/codecompanion.nvim/issues/447) moving between windows ([d3e88dd](https://github.com/SDGLBL/codecompanion.nvim/commit/d3e88dd8f66bf746d361c8ba96e862d4e3e4aa0f))
* **chat:** [#450](https://github.com/SDGLBL/codecompanion.nvim/issues/450) no longer remove autocmds ([ca1e4d8](https://github.com/SDGLBL/codecompanion.nvim/commit/ca1e4d837d224fc879e031fcea4613c29fade1c0))
...
* **chat:** changing model always changes settings ([318f40d](https://github.com/SDGLBL/codecompanion.nvim/commit/318f40d35bb53d663f8f80f26737b69430fe1c55))
* **chat:** clear references table ([7c0f6fb](https://github.com/SDGLBL/codecompanion.nvim/commit/7c0f6fb1687c4499075d02913e308279cfeb1b2a))
* **chat:** display tokens in chat buffer ([de55dd5](https://github.com/SDGLBL/codecompanion.nvim/commit/de55dd5c270e486cebf2d11861da41d816926051))
...
* **chat:** slash commands from prompt library not visible ([3376f60](https://github.com/SDGLBL/codecompanion.nvim/commit/3376f6052217737cb936236d9069bd4a63ccbace))
...
* **cmd:** users can now change adapters ([ec2e4df](https://github.com/SDGLBL/codecompanion.nvim/commit/ec2e4dfedbaf35fa79f03d9f73c4cf4089425359))
...
* **code_runner:** Ensure code is wrapped in CDATA ([f814137](https://github.com/SDGLBL/codecompanion.nvim/commit/f8141375d3b5c4e3b2d387e62d1754b72b62f517))
...
* **completion:** setting of keymaps ([03fbb0a](https://github.com/SDGLBL/codecompanion.nvim/commit/03fbb0ac20d3a028d9462efe49f3d53b60e92a8a))
* **config:** wrap completion condition in pcall ([d19ae05](https://github.com/SDGLBL/codecompanion.nvim/commit/d19ae05f561a7d3b5d311453285996e84cc925de))
* **copilot:** [#363](https://github.com/SDGLBL/codecompanion.nvim/issues/363) parameters overwritten when stream is true ([1c3449c](https://github.com/SDGLBL/codecompanion.nvim/commit/1c3449cf5b63b8b20bbe13842f047f2a220bf70a))
* **copilot:** make gpt-4o the default again ([28e8ddc](https://github.com/SDGLBL/codecompanion.nvim/commit/28e8ddc97e0044e5f04ddd261ac6fa06da9deca6))
...
* **diff:** diff split window wrongly opened in chat window ([#359](https://github.com/SDGLBL/codecompanion.nvim/issues/359)) ([21801b8](https://github.com/SDGLBL/codecompanion.nvim/commit/21801b88c5abb7c4b4b3e715a897505366a986d4))
* **diff:** is_visible() a nil value in default diff ([8d7a796](https://github.com/SDGLBL/codecompanion.nvim/commit/8d7a7965095925039dbfe34f56b0d72920e67545))
...
* **inline:** [#426](https://github.com/SDGLBL/codecompanion.nvim/issues/426) concat of lines ([34beee3](https://github.com/SDGLBL/codecompanion.nvim/commit/34beee3a1f5e97cde61bd906afa9ddd534aeb88c))
...
* **keymaps:** closing and opening chat buffer ([91a08d7](https://github.com/SDGLBL/codecompanion.nvim/commit/91a08d76d47e16f3779545b1f4267a1eb0be1cb1))
* **keymaps:** completion menu is now `&lt;c-_&gt;` ([24f296b](https://github.com/SDGLBL/codecompanion.nvim/commit/24f296bd2382bc9f50d387b5ac849410d6c2d491))
* mini.pick as action_palette provider ([adeb7c4](https://github.com/SDGLBL/codecompanion.nvim/commit/adeb7c42fb7fb1187c64773a46d5bfee8f85dacf))
* OpenAI-compatible adapter ([#446](https://github.com/SDGLBL/codecompanion.nvim/issues/446)) ([3bfc575](https://github.com/SDGLBL/codecompanion.nvim/commit/3bfc575dd69e43cb1b2d01868f1689d024d3bbe4))
* **openai:** [#458](https://github.com/SDGLBL/codecompanion.nvim/issues/458) handle models being a function ([041193b](https://github.com/SDGLBL/codecompanion.nvim/commit/041193b1b238d7b4980847a24c19c74dcf080029))
...
* **openai:** support streaming in o1 models ([7c77a82](https://github.com/SDGLBL/codecompanion.nvim/commit/7c77a82b1c726734c6b6022b3f4b657660e37b57))
* opening existing chats from the action palette ([59823c2](https://github.com/SDGLBL/codecompanion.nvim/commit/59823c232da7cbbc8a5fde5edbbf32578bd653b4))
...
* **slash_commands:** [#408](https://github.com/SDGLBL/codecompanion.nvim/issues/408) no symbols found in file ([aececa0](https://github.com/SDGLBL/codecompanion.nvim/commit/aececa030a05ad86614df3fcb0fae0c40c7bac13))
...
* **slash_commands:** fetch doesn't error on no input ([be9e36c](https://github.com/SDGLBL/codecompanion.nvim/commit/be9e36c217f15ff53b06c9eb2ba7c42de026dc70))
...
* **slash_commands:** show tracked and untracked files ([a7ad936](https://github.com/SDGLBL/codecompanion.nvim/commit/a7ad936a0b92177aa78be78d7661c3336e0ec7cf))
* **slash_commands:** telescope selection ([6184bd4](https://github.com/SDGLBL/codecompanion.nvim/commit/6184bd4e60d4f301cc5f47416a9a90731eb7f8fb))
...
* **slash_command:** symbols parsing ([ffbcefb](https://github.com/SDGLBL/codecompanion.nvim/commit/ffbcefbccaf9d59a9c0a56ce55507297c0130658))
...
* **tools:** [#467](https://github.com/SDGLBL/codecompanion.nvim/issues/467) reading of files on disk ([034ed9e](https://github.com/SDGLBL/codecompanion.nvim/commit/034ed9eec8f8726cc30f9854d92d6f608e399717))
...
* **tools:** add XML block formatting guidance ([#417](https://github.com/SDGLBL/codecompanion.nvim/issues/417)) ([315da62](https://github.com/SDGLBL/codecompanion.nvim/commit/315da62c789fd9053d5b17ba28bb78364d687d49))
...
* **tools:** editor diff should be cleared on_exit ([b143ee0](https://github.com/SDGLBL/codecompanion.nvim/commit/b143ee0831c59fe2ad3582883c09a24f6659b7b0))
...
* **tools:** rejected cmd tools close properly ([50d0d25](https://github.com/SDGLBL/codecompanion.nvim/commit/50d0d2543ed3115477cfacfd80db0e029857127e))
...
* **utils:** [#488](https://github.com/SDGLBL/codecompanion.nvim/issues/488) fix edge cases in visual selection ([84a8e89](https://github.com/SDGLBL/codecompanion.nvim/commit/84a8e8962e9ae20b8357d813dee1ea44a8079605))
...
* **utils:** vim.api being replaced with api.api ([40114d7](https://github.com/SDGLBL/codecompanion.nvim/commit/40114d760af19f2ac21a1c248a34dc4c734acf9f))
* **utils:** visual selection range no longer uses feedkeys ([e981da2](https://github.com/SDGLBL/codecompanion.nvim/commit/e981da23ae0e900a4086e8dcbc0b6abf86b737a9))
...
* release 8.10.1 ([1d3de26](https://github.com/SDGLBL/codecompanion.nvim/commit/1d3de2645b8f52c41caf502441a8299934a60dbe))
...
* move tools/slash/vars from helpers to strategies.chat ([806ed9c](https://github.com/SDGLBL/codecompanion.nvim/commit/806ed9cf17889347e03752516462e149e03a3ddf))
* **tools:** remove `code_runner` tool ([362076b](https://github.com/SDGLBL/codecompanion.nvim/commit/362076b1e10748dd8999f73fbe993fb9a446733f))
