...
#### The plugin now supports two types of agents

- Command-based Agents: These agents execute a series of shell commands or external scripts.
- Function-based Agents: These agents perform actions directly within Neovim, interacting closely with buffers and the editor environment.

#### The plugin comes with the following built-in agents
